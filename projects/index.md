...
{%
  ...
  size=full
%}
# {% include icon.html icon="fa-solid fa-circle-question" %}“How does tumor-associated myelopoiesis impact BM cells epigenetically?” 
{%
  include figure.html
...
{%
  ...
  size=full
%}
# {% include icon.html icon="fa-solid fa-circle-question" %}“Is the steady-state fate of BM stem cells and multipotent progenitors altered by cancer inflammation?”
{%
  include figure.html
...
{%
  ...
  size=full
%}
# {% include icon.html icon="fa-solid fa-circle-question" %}“How do acute or chronic genotoxic therapies impact reactive myelopoiesis?”
{%
  include figure.html
...
{%
  ...
  size=full
%}
# {% include icon.html icon="fa-solid fa-circle-question" %}“Does myelopoiesis in response to therapies influence metastatic dissemination and/or dormancy exit?”
{%
  include figure.html
