...
# {% include icon.html icon="fa-solid fa-wrench" %} Our Mission
...
* #### Train the next generation of cancer immunologists with a translational + activist mindset.


# {% include icon.html icon="fa-solid fa-wrench" %}Our Values

1) # __*Curiosity is celebrated*__
...
2) __*Collegiality will take us far*__
...
3) __*Open Communication is key*__
...
4) __*Diversity of People and Ideas is critical*__ 
