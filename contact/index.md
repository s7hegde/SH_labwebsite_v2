...
All first-year Ph.D. graduate students are accepted into the [Graduate Division Umbrella program](https://einsteinmed.edu/education/phd/phd-program/) without making a commitment to any specific department or training program. Similarly, M.D. Ph.D. student are matriculated into the [Medical Scientist Training Program](https://einsteinmed.edu/education/mstp/). If you are interested in rotating in our lab prior to a mutually-decided decision, please reach out as follows:

1.	Email Samarth with the subject line “Student rotation: [your name]”.\
2.	Please include a copy of your CV (filename as [your last name]_[your first name]_CV.pdf) and a cover letter stating your motivation for pursuing this opportunity, summarizing your research interests and prior experience.\
3.	Please include contact information (both email and phone number) for 2 professional references.\
...
2.	Please include a copy of your CV (filename as [your last name]_[your first name]_CV.pdf) and a cover letter stating your motivation for pursuing this opportunity, summarizing your research interests and prior experience.\
3.	Please include contact information (both email and phone number) for 3 professional references.\

If we like your application, we will set up a time for a video conference call through Einstein HR. This will take 30 mins~1 hour. At this stage, we might reach out directly to your references. 

*For postdocs, if we think you may be a good fit, we might invite you out for an on-site interview. The on-site interview will likely take up an entire day. It will involve a job presentation in addition to one-on-one discussions with Dr. Hegde as well as others in the department, including faculty, peer post-docs, as well as graduate students and staff.* 
